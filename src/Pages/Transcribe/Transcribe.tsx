...
const Transcribe: React.FC = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.containera}>
        {/* Placeholder for fileText */}
        <div
          className={styles.fileText}
          style={{ color: isColorInverted ? "#fafafa" : "initial" }}
        >
          {/* Your fileText content goes here */}
        </div>

        {/* Conditionally render Player if form.file and uploadFile exist */}
        {form.file && uploadFile && <Player audioFile={form.file} />}
      ...
      {/* Table component to display transcriptions */}
      <Table
        title="Transcrições em andamento"
        columns={columns}
        data={updated}
